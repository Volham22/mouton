...
PYBIND11_EMBEDDED_MODULE(Mouton, m)
{
    ...
    py::class_<glm::vec2>(m, "Vector2")
        ...
        .def("__getitem__",
             [](const glm::vec2& vec, int32_t key) { return vec[key]; })
        .def("__setitem__",
             [](glm::vec2& vec, int32_t key, float value) { vec[key] = value; })
        .def(py::self * py::self)
        .def(py::self *= py::self)
        .def(py::self + py::self)
        .def(py::self += py::self)
    ...
    py::class_<glm::vec3>(m, "Vector3")
        ...
        .def("__getitem__",
             [](const glm::vec3& vec, int32_t key) { return vec[key]; })
        .def("__setitem__",
             [](glm::vec3& vec, int32_t key, float value) { vec[key] = value; })
    ...
    py::class_<glm::vec4>(m, "Vector4")
        ...
        .def("__getitem__",
             [](const glm::vec4& vec, int32_t key) { return vec[key]; })
        .def("__setitem__",
             [](glm::vec4& vec, int32_t key, float value) { vec[key] = value; })
    ...
    py::class_<glm::mat2>(m, "Matrix2")
        ...
        .def("__getitem__",
             &InternalTypeUtils::GetMatrixIndex<glm::mat2, glm::vec2>)
        .def("__getitem__", &InternalTypeUtils::GetMatrix2DIndex<glm::mat2>)
        .def("__setitem__",
             &InternalTypeUtils::AssignMatrixIndex<glm::mat2, glm::vec2>)
        .def("__setitem__",
             &InternalTypeUtils::AssignMatrixIndex<glm::mat2, float>)
    ...
    py::class_<glm::mat3>(m, "Matrix3")
        ...
        .def("__getitem__",
             &InternalTypeUtils::GetMatrixIndex<glm::mat3, glm::vec3>)
        .def("__getitem__", &InternalTypeUtils::GetMatrix2DIndex<glm::mat3>)
        .def("__setitem__",
             &InternalTypeUtils::AssignMatrixIndex<glm::mat3, glm::vec3>)
        .def("__setitem__",
             &InternalTypeUtils::AssignMatrixIndex<glm::mat3, float>)
    ...
    py::class_<glm::mat4>(m, "Matrix4")
        ...
        .def("__getitem__",
             &InternalTypeUtils::GetMatrixIndex<glm::mat4, glm::vec4>)
        .def("__getitem__", &InternalTypeUtils::GetMatrix2DIndex<glm::mat4>)
        .def("__setitem__",
             &InternalTypeUtils::AssignMatrixIndex<glm::mat4, glm::vec4>)
        .def("__setitem__",
             &InternalTypeUtils::AssignMatrixIndex<glm::mat4, float>)
    ...
    py::class_<OrthographicCameraComponent>(m, "OrthographicCameraComponent")
        ...
        .def("ToString",
             &InternalTypeUtils::ToString<OrthographicCameraComponent>)
        .def("__str__",
             &InternalTypeUtils::ToString<OrthographicCameraComponent>)
    ...
    py::class_<PythonAPI::Core>(m, "Core").def_static("Print",
                                                      &PythonAPI::Core::Print);

    py::class_<PythonInternalMath>(m, "Math")
        .def("Cross", [](const glm::vec3& x,
                         const glm::vec3& y) { return glm::cross(x, y); })
