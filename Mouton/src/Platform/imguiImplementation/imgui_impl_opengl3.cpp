...
//  ImGuiPlatformIO interface. 2020-04-12: OpenGL: Fixed context version check
...
// Auto-enable GLES on matching platforms
        ...
        #define IMGUI_IMPL_OPENGL_ES2 // Emscripten    -> GL ES 2, "#version
                                      // 100"
    #endif
#endif
...
// GL includes
    ...
    //  purpose! Here we are supporting a few common ones (gl3w, glew, glad).
    //  You may use another loader/header of your choice (glext, glLoadGen,
